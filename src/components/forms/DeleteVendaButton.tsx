        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-sm overflow-hidden border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2 font-mono italic text-red-600">Excluir Venda</h3>
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">Tem certeza que deseja apagar a **Venda #{numero}**? Esta ação não pode ser desfeita.</p>
