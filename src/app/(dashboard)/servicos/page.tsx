    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white p-4 rounded-md shadow-sm border border-gray-200">
        <div className="flex items-center gap-4">
          <h2 className="text-gray-900 font-bold text-2xl mb-0">Serviços</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/servicos/create" className="flex items-center gap-1.5 bg-[#00a65a] hover:bg-green-600 transition-colors text-white text-sm font-bold px-4 py-2 rounded shadow-sm">
