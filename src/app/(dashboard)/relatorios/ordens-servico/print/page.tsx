...
function RelatorioOSPrintContent() {
  ...
  if (isPending)
    return <div className="p-8">Gerando relatório de O.S. consolidado...</div>;

  return (
    <RelatorioPrintChrome
      backHref="/relatorios/ordens-servico"
      reportSubtitle="Relatório Consolidado de Ordens de Serviço"
    >
        ...
        <tbody>
          <tr className="border-b border-black">
            ...
            <td className="p-1.5 uppercase font-bold">
              Assistência Técnica (O.S. Consolidado Diário)
            </td>
          </tr>
          <tr className="border-b border-black">
