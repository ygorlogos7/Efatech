    ...
    <div className="min-h-screen bg-white pb-10">
      ...
      <div className="flex justify-between items-center px-4 py-4 border-b border-gray-100 mb-6 bg-white shadow-sm">
        <div className="flex items-center gap-2">
            ...
            <h1 className="text-[20px] font-normal text-gray-800">Relatório de O.S. (Consolidado Diário)</h1>
        </div>
        ...
        <div className="flex items-center gap-1.5 text-[12px] text-gray-400">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-gray-400">Ordens de Serviço</span>
        </div>
      </div>
      ...
      <div className="px-4">
          ...
          <div className="flex gap-2">
            <button 
              onClick={() => {
                ...
                window.open(`/relatorios/ordens-servico/print?${params.toString()}`, '_blank');
              }}
          ...
          <div className="bg-white border border-gray-200 rounded p-6 mb-6 shadow-sm">
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <div className="space-y-1.5">
                   <label className="text-[12px] font-black text-gray-700 uppercase tracking-wider">Cliente (Filtro por O.S.)</label>
                   <input 
                     type="text"
                ...
                <div className="space-y-1.5">
                   <label className="text-[12px] font-black text-gray-700 uppercase tracking-wider">Período de Abertura</label>
                   <div className="flex items-center gap-2">
                      <input 
                        type="date"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white border border-gray-200 p-4 rounded shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase">Total Serviços Período</p>
          ...
          <div className="bg-white border border-gray-200 p-4 rounded shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase">Dias com Atendimento</p>
          ...
          <div className="bg-white border border-gray-200 p-4 rounded shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase">Ticket Médio Diário</p>
        ...
        <div className="border border-gray-200 rounded shadow-sm bg-white overflow-hidden">
          <table className="w-full text-left text-[13px] border-collapse">
            <thead className="bg-[#f9f9f9] border-b border-gray-200">
              <tr className="text-gray-800 font-bold uppercase tracking-tight text-[11px]">
                ...
                <th className="px-4 py-3 border-r border-gray-200 text-center">Qtd. O.S.</th>
              ...
              {os.length === 0 ? (
                ...
                os.map((item, idx) => (
                  <tr key={idx} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3 text-gray-600 font-medium">{formatDate(item.data)}</td>
                    <td className="px-4 py-3 text-center text-gray-500">{item.qtd} atendimentos</td>
                    <td className="px-4 py-3 text-right text-gray-900 font-black">{formatCurrency(item.total)}</td>
                  </tr>
                ))
              )}
            </tbody>
          ...
          <div className="px-4 py-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between bg-white gap-4">
            ...
            <div className="flex items-center -space-x-px">
              <button
                onClick={() => loadOS(Math.max(1, page - 1))}
                disabled={page === 1}
              ...
              <button
                onClick={() => loadOS(Math.min(totalPages, page + 1))}
