...
function RelatorioVendasPrintContent() {
  ...
  useEffect(() => {
    startTransition(async () => {
      // Para o relatório total, aumentamos o pageSize ou removemos o limite
      const resp = await getRelatorioVendas({ dataInicio, dataFim, cliente }, 1, 9999);
      if (resp.success) {
        setData(resp.data || []);
  ...
  if (isPending) return <div className="p-8">Gerando relatório consolidado...</div>;
  ...
  return (
    <div className="bg-white text-black p-4 font-sans text-[12px] leading-tight max-w-[800px] mx-auto print:max-w-full print:p-0 print-container">
      ...
      <div className="max-w-[800px] mx-auto mb-4 mt-6 p-4 print:hidden flex justify-between items-center bg-white shadow-2xl rounded-2xl border border-gray-100">
          <Link href="/relatorios/vendas" className="px-4 py-1.5 bg-gray-50 text-sm font-bold border rounded-lg hover:bg-black hover:text-white transition-all flex items-center gap-2">
      ...
      <div className="border border-gray-300 p-4 mb-4 flex justify-between items-center">
        <div className="flex items-center gap-4">
           ...
           <div>
              ...
              <p className="text-[10px] text-gray-500">Relatório Consolidado de Vendas</p>
           </div>
        </div>
      ...
      <table className="w-full border-collapse border border-black mb-6">
        <tbody>
          <tr className="border-b border-black">
            ...
            <td className="p-1.5 uppercase font-bold">Vendas Balcão (Consolidado Diário)</td>
          </tr>
          <tr className="border-b border-black">
          ...
          <tr className="border-b border-black">
            <td className="border-r border-black p-1.5 font-bold bg-gray-50">Total de Dias com Venda</td>
            <td className="p-1.5 font-bold">{data.length} dias</td>
          </tr>
          <tr>
            <td className="border-r border-black p-1.5 font-bold bg-gray-50">Faturamento Bruto Total</td>
      ...
      <table className="w-full border-collapse border border-black text-center mb-10">
        <thead className="bg-gray-100 border-b border-black font-bold text-[10px]">
          <tr>
            ...
            <td className="border-r border-black p-1.5">Quantidade de Vendas</td>
        ...
        <tfoot className="bg-gray-50 font-bold text-[11px]">
           <tr>
              <td colSpan={2} className="border-r border-black p-2 text-right uppercase">Total Acumulado</td>
