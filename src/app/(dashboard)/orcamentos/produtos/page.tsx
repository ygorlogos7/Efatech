...
import { PlusCircle, SearchIcon, Edit2, Box, Package, Printer, Share2, FileText, RefreshCw, Coins, DollarSign, CheckSquare, MessageCircle, Mail, ChevronRight, Eye, X } from "lucide-react";
                      ...
                      <MoreActionsDropdown 
                        ...
                        actions={[
                          ...
                          { 
                            ...
                            subItems: [
                              { label: "Formato A4", href: `/orcamentos/produtos/print/${item.Id}` },
                              { label: "Cupom", href: `/orcamentos/produtos/print/${item.Id}` },
                              { label: "Produção", href: `/orcamentos/produtos/print/${item.Id}` },
                            ]
                          },
