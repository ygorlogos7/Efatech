  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-2">
        <h1 className="text-2xl text-gray-700 font-normal">{greeting}, Admin</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#0070c0] text-white rounded-md shadow p-5 min-h-[140px] flex flex-col relative group">
          <div className="flex justify-between items-start mb-2 opacity-90">
            <h3 className="font-semibold text-sm">Recebimentos do mes</h3>
          ...
          <div className="flex-1 flex items-center gap-4">
            <div className="relative w-14 h-14 shrink-0">
              <svg className="w-full h-full transform -rotate-90">
                ...
                <circle cx="28" cy="28" r="24" stroke="currentColor" strokeWidth="4" fill="none" strokeDasharray="150" strokeDashoffset={150 - (150 * (recebimentos.percentual)) / 100} className="text-white" />
              </svg>
        ...
        <div className="bg-[#0070c0] text-white rounded-md shadow p-5 min-h-[140px] flex flex-col relative group">
          ...
          <div className="flex-1 flex items-center gap-4">
            <div className="relative w-14 h-14 shrink-0">
              <svg className="w-full h-full transform -rotate-90">
                <circle cx="28" cy="28" r="24" stroke="currentColor" strokeWidth="4" fill="none" className="opacity-20" />
                <circle cx="28" cy="28" r="24" stroke={pagamentos.percentual >= 100 ? "#00b050" : "currentColor"} strokeWidth="4" fill={pagamentos.percentual >= 100 ? "#00b050" : "none"} strokeDasharray="150" strokeDashoffset={pagamentos.percentual >= 100 ? 0 : 150 - (150 * (pagamentos.percentual)) / 100} className="text-white" />
              </svg>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-4">
        ...
        <div className="bg-white rounded-md shadow-sm p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg text-gray-700 font-medium">Grafico de vendas</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-6">
        <div className="bg-white rounded-md shadow-sm">
          <div className="flex justify-between items-center p-6 pb-0">
            <h2 className="text-lg text-gray-700 font-medium">Contas bancarias</h2>
            <button className="text-gray-400 hover:text-gray-600 transition-colors">
        ...
        <div className="bg-white rounded-md shadow-sm overflow-hidden flex flex-col">
          <div className="flex justify-between items-center p-6 pb-4">
            <h2 className="text-lg text-gray-700 font-medium">Calendario</h2>
